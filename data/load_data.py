...
EXPANDED_IDIOMS: Dict[str, str] = {
    ...
    "ein fass aufmachen": "make a big scene",
    "den ball flach halten": "keep a low profile",
    "das eis brechen": "break the ice",
    "einen klaren kopf behalten": "keep a clear head",
    "auf die tube druecken": "step on it",
    "jemanden um den finger wickeln": "wrap someone around one's finger",
    "die kirche ums dorf tragen": "take the long way around",
    "den teufel im leibe haben": "be full of the devil",
    "schmiere stehen": "keep watch",
    "unter aller sau": "beneath contempt",
    "die sau rauslassen": "paint the town red",
    "da beißt die maus keinen faden ab": "there is no way around it",
    "ein hühnchen mit jemandem zu rupfen haben": "have a bone to pick with someone",
    "die ohren steif halten": "keep one's chin up",
    "auf dem zahnfleisch gehen": "be on one's last legs",
    "den löffel abgeben": "kick the bucket",
    "alles auf eine karte setzen": "put all one's eggs in one basket",
    "jemanden in die pfanne hauen": "throw someone under the bus",
    "den inneren schweinehund überwinden": "overcome one's weaker self",
    "ein auge auf jemanden werfen": "keep an eye on someone",
    "den kopf hängen lassen": "be down in the dumps",
    "jemandem die augen öffnen": "open someone's eyes",
    "auf wolke sieben schweben": "be on cloud nine",
    "den faden wieder aufnehmen": "pick up the thread",
    "ein offenes ohr haben": "be all ears",
    "jemandem auf den leim gehen": "be taken in by someone",
    "die erste geige spielen": "play first fiddle",
    "jemanden an der nase herumführen": "lead someone by the nose",
    "den wald vor lauter bäumen nicht sehen": "not see the wood for the trees",
    "auf der leitung stehen": "be slow on the uptake",
    "jemandem honig um den mund schmieren": "butter someone up",
    "die hosen anhaben": "wear the trousers",
    "das blaue vom himmel versprechen": "promise the moon",
    "jemandem den marsch blasen": "give someone a piece of one's mind",
    "auf die schippe nehmen": "pull someone's leg",
    "das letzte wort haben": "have the last word",
    "einen bärenhunger haben": "be hungry as a horse",
    "die nase in alles stecken": "poke one's nose into everything",
}
